...
(defun controller-callback (index)
  (logior
   ...
   (ash (if (or (gamepad-button (gamepad index) 11)
                (keyboard-button (keyboard) key.up))
          0 1)
        4)
   (ash (if (or (gamepad-button (gamepad index) 14)
                (keyboard-button (keyboard) key.right))
          0 1)
        5)
   (ash (if (or (gamepad-button (gamepad index) 12)
                (keyboard-button (keyboard) key.down))
          0 1)
        6)
   (ash (if (or (gamepad-button (gamepad index) 13)
   ...
   (ash (if (or (gamepad-button (gamepad index) 0)
                (keyboard-button (keyboard) key.return))
          0 1)
        14)
